...
/*   Updated: 2024/10/14 17:13:50 by javjimen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	swap(stack_a);
	add_operation(stack_a, stack_b, stack_o, SA);
}

void	sb(t_list **stack_a, t_list **stack_b, t_list **stack_o)
{
	swap(stack_b);
	add_operation(stack_a, stack_b, stack_o, SB);
}
...
void	ss(t_list **stack_a, t_list **stack_b, t_list **stack_o)
{
	swap(stack_a);
	swap(stack_b);
	add_operation(stack_a, stack_b, stack_o, SS);
}
