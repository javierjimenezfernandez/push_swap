...
/*   Updated: 2024/10/14 17:13:18 by javjimen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rra(t_list **stack_a, t_list **stack_b, t_list **stack_o)
{
	...
	add_operation(stack_a, stack_b, stack_o, RRA);
}

void	rrb(t_list **stack_a, t_list **stack_b, t_list **stack_o)
{
	reverse_rotate(stack_b);
	add_operation(stack_a, stack_b, stack_o, RRB);
}
...
void	rrr(t_list **stack_a, t_list **stack_b, t_list **stack_o)
{
	reverse_rotate(stack_a);
	reverse_rotate(stack_b);
	add_operation(stack_a, stack_b, stack_o, RRR);
}
